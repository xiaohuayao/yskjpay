	...
	<div class="app-container">
		...
		<div class="filter-container">
			...
			<el-date-picker v-model="time" type="datetimerange" :picker-options="pickerOptions" range-separator="至"
			 start-placeholder="请选择开始日期" end-placeholder="请选择结束日期" align="right" :default-time="['00:00:00', '23:59:59']">
			</el-date-picker>
		...
		<el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
			...
			<el-table-column label="行社名称" align="center" v>
		...
		<el-pagination :total="total" :current-page="page" :page-sizes="[ 20, 50, 100, 200, 300, 400]" style="margin-top: 8px;"
	...
	export default {
		...
		methods: {
			fetchData(type) {
				...
				getpageListClub(this.query).then(response => {
					//debugger;      
