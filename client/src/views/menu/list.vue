<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="menuList" row-key="id" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
      ...
      <el-table-column prop="component" label="组件地址" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="route" label="路由地址" :show-overflow-tooltip="true"></el-table-column>
      <!-- <el-table-column prop="status" label="状态" :formatter="statusFormat" width="80"></el-table-column> -->
      <el-table-column label="创建时间" align="center" prop="createtime"></el-table-column>
      <el-table-column label="操作" align="center" width="300px">
        <template slot-scope="scope">
			<el-button class="filter-item" @click="handleUpdate(scope.row)" type="warning" size="mini" icon="el-icon-edit">
			  修改
			</el-button>
			<el-button class="filter-item" @click="handleAdd(scope.row)" type="primary" size="mini" icon="el-icon-plus">
			  新增
			</el-button>
			<el-button class="filter-item" @click="handleDelete(scope.row)" type="danger" size="mini" icon="el-icon-delete">
			  删除
			</el-button>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="组件名称" prop="title">
              <el-input v-model="form.title" placeholder="请输入组件名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
